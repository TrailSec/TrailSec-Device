...
C_SRCS += modules/images/_bluetoothPairing.c
C_SRCS += modules/images/_checkIn.c
C_SRCS += modules/images/_main.c
C_SRCS += modules/images/_splashscreen.c
C_SRCS += modules/images/_watchframe.c
C_SRCS += modules/touchscreen/touchscreen.c
C_SRCS += modules/wifi/wifi.c
C_SRCS += views/router.c
C_SRCS += views/view_bluetoothPairing.c
C_SRCS += views/view_checkIn.c
C_SRCS += views/view_main.c
C_SRCS += views/view_splashscreen.c
CXX_SRCS :=
ASM_SRCS :=
